...
import in.dropcodes.walldrop.Adapter.LatestFragmentAdapter;
...
public class LatestFragment extends Fragment {
    ...
    private String URL = "https://pixabay.com/api/?key=9910517-7462ed0a9b57cffbe5dcdb6ae&order=latest";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = view.findViewById(R.id.latest_recycler_view);
        mRecyclerView.setHasFixedSize(true);
        mRecyclerView.setLayoutManager(new GridLayoutManager(getContext(), 2));

        swipeRefreshLayout = view.findViewById(R.id.latest_swipeRefresh);
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            adapter = new LatestFragmentAdapter(getContext(),mainModels);
