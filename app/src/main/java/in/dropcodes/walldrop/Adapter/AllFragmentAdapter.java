...
public class AllFragmentAdapter extends RecyclerView.Adapter<AllFragmentAdapter.MainViewHolder> {

    private Context mContext;
    private ArrayList<MainModel> mainModels;

    public AllFragmentAdapter(Context mContext, ArrayList<MainModel> mainModels) {
